var define, self = null;
(function (f) { if (typeof exports === "object" && typeof module !== "undefined") { module.exports = f() } else if (typeof define === "function" && define.amd) { define([], f) } else { var g; if (typeof window !== "undefined") { g = window } else if (typeof global !== "undefined") { g = global } else if (typeof self !== "undefined") { g = self } else { g = this } g.MeteorEmoji = f() } })(function () {
          ...
          _createClass(MeteorEmoji, [{
            ...
            value: function generateElements(emojiInput) {
              ...
              var clickCategory = function clickCategory(event) {
                ...
                var i = 0, l = backgroundToggle.length;
                ...
                emojiPicker.querySelector("#" + event.target.id).style.background = "rgba(23, 23, 23, 0.88)";
              };
              ...
              if (emojiInput.hasAttribute("data-meteor-emoji-large")) {
                ...
                emojiPicker.style.bottom = "45px";
                emojiPicker.style.display = "none";
              }
              emojiPicker.style.zIndex = "999";
              emojiPicker.style.overflow = "hidden";
              emojiPicker.style.background = "rgba(23, 23, 23, 0.88)";
              emojiPicker.style.borderRadius = "5px";
              emojiPicker.style.padding = "0";
              ...
              emojiTrigger.style.height = "25px";
              ...
              emojiCategory.style.background = "rgb(70, 70, 70)";
              ...
              emojiCategories.map(function (item) {
                ...
                if (String(item["name"]) == "faces") {
                  emojiLink.style.background = "rgba(23, 23, 23, 0.88)";
                }
              ...
              emojiContainer.parentNode.appendChild(emojiPicker);
            }
          }]);
